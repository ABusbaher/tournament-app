...
<template>
    <div class="relative w-3/4">
        ...
        <label
            for="fileInput"
            class="flex items-center justify-center w-full px-4 py-2 bg-gray-200 border border-gray-300 rounded-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
        ...
        <span v-if="file" class="block text-center mt-1 text-sm text-gray-500 dark:text-gray-300">New image: {{ file.name }}</span>
    </div>
</template>
