                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        ...
                        <div class="ml-3 relative">
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    <a v-for="tournament in tournaments" :class="mobileLinkClasses" :href="route('team.all', {tournament: tournament.id})"> {{ tournament.name }} teams </a>
                                </template>
                            </Dropdown>
                        </div>
                    </div>
            ...
            >
                ...
                <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                    <div class="px-4">
                        ...
                        <div class="font-medium text-sm text-gray-500">ee</div>
                    </div>

                    <div class="mt-3 space-y-1">
                        <a v-for="(value, key) in eliminationGames" :class="mobileLinkClasses" :href="route('elimination.games', {tournament: key})"> {{ value }} games </a>
                        <a v-for="(value, key) in games" :class="mobileLinkClasses" :href="route('fixture.games', {tournament: key, fixture: 1})"> {{ value }} games </a>
                        <a v-for="tournament in tournaments" :class="mobileLinkClasses" :href="route('team.all', {tournament: tournament.id})"> {{ tournament.name }} teams </a>
