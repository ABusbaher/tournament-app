...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Ažuriraj Lozinku</h2>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="password_confirmation" value="Potvrdi Lozinku" />
            ...
            <div class="flex items-center gap-4">
                ...
                <Transition enter-from-class="opacity-0" leave-to-class="opacity-0" class="transition ease-in-out">
                    <p v-if="form.recentlySuccessful" class="text-sm text-gray-600 dark:text-gray-400">Sačuvano.</p>
                </Transition>
            </div>
        </form>
    </section>
